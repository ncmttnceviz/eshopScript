...
Route::group(['namespace'=>'admin','prefix'=>'admin','as'=>'admin.','middleware'=>['auth', '\App\Http\Middleware\adminController']], function (){
    ...
    Route::post('/'.__('categories').'/'.__('create'), [\App\Http\Controllers\Admin\Categories\indexController::class, "store"])->name('category.create.post');
    Route::get('/'.__('categories').'/'.__('edit').'/{id}',[\App\Http\Controllers\Admin\Categories\indexController::class, 'edit'])->name('category.edit');
    Route::post('/'.__('categories').'/'.__('edit').'/{id}',[\App\Http\Controllers\Admin\Categories\indexController::class, 'update'])->name('category.edit.post');
    Route::get('/'.__('categories').'/'.__('delete').'/{id}',[\App\Http\Controllers\Admin\Categories\indexController::class, 'delete'])->name('category.delete');
    ...
    Route::post('/'.__('products').'/'.__('create'),[\App\Http\Controllers\Admin\Products\indexController::class, 'store'])->name('product.create.post');
    Route::get('/'.__('products').'/'.__('edit').'/{id}',[\App\Http\Controllers\Admin\Products\indexController::class, 'edit'])->name('product.edit');
    Route::post('/'.__('products').'/'.__('edit').'/{id}',[\App\Http\Controllers\Admin\Products\indexController::class, 'update'])->name('product.edit.post');
    Route::get('/'.__('products').'/'.__('publish').'/{id}/{status}',[\App\Http\Controllers\Admin\Products\indexController::class, 'publishStatus'])->name('product.publish');
    Route::get('/'.__('products').'/'.__('status').'/{id}/{status}',[\App\Http\Controllers\Admin\Products\indexController::class, 'trendHotStatus'])->name('product.trendHotStatus');
    ...
    Route::post('/'.__('products').'/'.__('edit').'/'.__('images').'/{id}', [\App\Http\Controllers\Admin\Products\indexController::class, 'uploadImage'])->name('product.image.post');
    Route::get('/'.__('products').'/'.__('delete').'/'.__('images').'/{id}', [\App\Http\Controllers\Admin\Products\indexController::class, 'deleteImage'])->name('product.image.delete');
    ...
    Route::post('/'.__('orders').'/'.__('edit').'/{orderNumber}', [\App\Http\Controllers\Admin\Orders\indexController::class,'trackingNumber'])->name('orders.detail.post');
    Route::post('/'.__('orders').'/'.__('complete').'/{orderNumber}', [\App\Http\Controllers\Admin\Orders\indexController::class,'completeOrder'])->name('orders.complete.post');
    Route::get('/'.__('config'),[\App\Http\Controllers\Admin\Config\indexController::class,'index'])->name('config.index');
    Route::post('/'.__('config'),[\App\Http\Controllers\Admin\Config\indexController::class,'update'])->name('config.update');
    Route::get('/'.__('config').'/info',[\App\Http\Controllers\Admin\Config\indexController::class,'info'])->name('config.info');
    Route::post('/'.__('config').'/info',[\App\Http\Controllers\Admin\Config\indexController::class,'infoUpdate'])->name('config.info.update');
    Route::get('/'.__('config').'/'.__('faq'),[\App\Http\Controllers\Admin\Config\indexController::class,'faq'])->name('config.faq');
    Route::post('/'.__('config').'/'.__('faq'),[\App\Http\Controllers\Admin\Config\indexController::class,'faqupdate'])->name('config.faq.update');
    Route::get('/'.__('config').'/'.__('faq').'/'.__('delete').'/{id}',[\App\Http\Controllers\Admin\Config\indexController::class,'faqDelete'])->name('config.faq.delete');
    Route::post('/'.__('config').'/'.__('faq').'/'.__('create'),[\App\Http\Controllers\Admin\Config\indexController::class,'faqCreate'])->name('config.faq.create');
    Route::get('/'.__('banner'),[\App\Http\Controllers\Admin\Banners\indexController::class,'index'])->name('banners');
    Route::post('/'.__('banner'),[\App\Http\Controllers\Admin\Banners\indexController::class, 'store'])->name('banners.post');
